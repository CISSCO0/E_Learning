...
export class ChatService {
  constructor(
    ...
    @InjectModel(onmessage.name) private messageModel: Model<ChatMessage>,
  ...
  async deleteChat(id: string): Promise<void> {
    ...
    // Delete the chat itself without deleting the associated messages
...
// ///////////////////////
  ...
  async addMessage(chatId: string, senderId: string, content: string): Promise<ChatMessage> {
